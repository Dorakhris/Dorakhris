...
I’m a cybersecurity professional specializing in **Digital Forensics**, **Threat Intelligence**, and **SOC operations**, with a passion for defending against cyber threats. Skilled in tools like Autopsy, Wireshark, and Splunk, I’m also exploring **Governance, Risk, and Compliance (GRC)** to broaden my impact. This repository reflects my journey and expertise in the field of cybersecurity, showcasing my projects and skills.

## Objective
Driven by a passion for cybersecurity, I aim to excel in DFIR, SOC, and Threat Intelligence. Through hands-on projects, I leverage tools like Autopsy, Splunk, and Wireshark to investigate threats and secure environments. I’m also exploring GRC to strengthen organizational security through policy and compliance.
